...
def process_stats(data: dict) -> dict:
    ...
    # ⚡ Bolt Optimization: Consolidate multiple O(N) iterations over repo_nodes into a single loop.
    # Previously we iterated multiple times to calculate total_stars, total_forks, language_sizes, and private_included.
    total_stars = 0
    total_forks = 0
    language_sizes = {}
    has_private = restricted_contribs > 0
