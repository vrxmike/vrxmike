...
def process_stats(data: dict) -> dict:
    ...
    # BOLT OPTIMIZATION: Combine multiple O(n) loops over repo_nodes into a single loop
    # Previously we iterated repo_nodes 3-4 times (stars, forks, languages, private check)
    total_stars = 0
    total_forks = 0
    language_sizes = {}
